...
class PositionMapperTest {
    ...
    @Test
    void e4ShouldMapToRow4Col4() {
        Position p = PositionMapper.fromString("e4");
        assertThat(p.row()).isEqualTo(4);
        assertThat(p.col()).isEqualTo(4);
    }

    @Test
    void row7Col0ShouldMapToA1() {
        assertThat(PositionMapper.toString(new Position(7, 0))).isEqualTo("a1");
    }

    @Test
    void row0Col7ShouldMapToH8() {
        assertThat(PositionMapper.toString(new Position(0, 7))).isEqualTo("h8");
    }

    @Test
    void a8ShouldMapToRow0Col0() {
    ...
    @Test
    void row0Col0ShouldMapToA8() {
        assertThat(PositionMapper.toString(new Position(0, 0))).isEqualTo("a8");
    }

    @Test
    void row7Col7ShouldMapToH1() {
        assertThat(PositionMapper.toString(new Position(7, 7))).isEqualTo("h1");
    }
