...
class MoveGeneratorTest {
    ...
    void rookShouldStopBeforeOwnPiece() {
        ...
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(4, 4));
        assertThat(moves)
                .doesNotContain(new Position(4, 6), new Position(4, 7))
                .contains(new Position(4, 5));
    }
    ...
    void rookShouldCaptureEnemyAndStop() {
        ...
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(4, 4));
        assertThat(moves)
                .contains(new Position(4, 6))
                .doesNotContain(new Position(4, 7));
    }
    ...
    void knightShouldSkipOwnPieceSquare() {
        ...
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(4, 4));
        assertThat(moves)
                .doesNotContain(new Position(2, 5))
                .hasSize(7);
    }
    ...
    void kingShouldNotCaptureOwnPiece() {
        ...
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(4, 4));
        assertThat(moves)
                .doesNotContain(new Position(3, 4))
                .hasSize(7);
    }
    ...
    void whiteKingShouldNotCastleWhenKingHasMoved() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(0, 6));
    }
    ...
    void whiteKingShouldNotCastleWhenNoRook() {
        ...
        assertThat(moves)
                .doesNotContain(new Position(0, 6))
                .doesNotContain(new Position(0, 2));
    }
    ...
    void whiteKingShouldNotCastleWhenSquaresOccupied() {
        ...
        assertThat(moves)
                .doesNotContain(new Position(0, 6), new Position(0, 2));
    }
    ...
    void blackKingShouldNotCastleWhenRookHasMoved() {
        ...
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(7, 4));
        assertThat(moves).doesNotContain(new Position(7, 6), new Position(7, 2));
    }
    ...
    void blackKingShouldNotCastleQueensideWhenCol2Occupied() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(7, 2));
    }
    ...
    void whitePawnShouldNotCaptureOwnPiece() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(3, 3));
    }
    ...
    void whitePawnShouldNotCaptureOwnPieceOnRightDiagonal() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(3, 5));
    }
    ...
    void whitePawnShouldNotIncludeEnPassantWhenNotAdjacent() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(5, 7));
    }
    ...
    void blackPawnShouldNotDoubleMoveWhenAlreadyMoved() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(4, 4));
    }
    ...
    void blackPawnShouldNotCaptureOwnPiece() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(4, 5));
    }
    ...
    void blackPawnShouldNotCaptureOwnPieceOnLeftDiagonal() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(4, 3));
    }
    ...
    void blackPawnShouldNotIncludeEnPassantWhenNotAdjacent() {
        ...
        assertThat(moves)
                .isNotEmpty()
                .doesNotContain(new Position(2, 0));
    }
    ...
    void blackPawnShouldNotMoveWhenBlocked() {
        ...
        board.setPiece(4, 4, new Pawn(Color.WHITE));
        List<Position> moves = gen.getPseudoLegalMoves(game, board, new Position(5, 4));
        assertThat(moves).doesNotContain(new Position(4, 4), new Position(3, 4));
    }
